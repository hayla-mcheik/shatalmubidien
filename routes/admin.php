...
Route::prefix('admin')->middleware(['auth','role:admin'])->group(function () {
    ...
    Route::post('/partner/add',       [App\Http\Controllers\PartnerController::class, 'addpartner'])->name('partner.add');
    Route::post('/partner/update/{id}', [App\Http\Controllers\PartnerController::class, 'updatepartner'])->name('partner.update');
    Route::get('/partner/delete/{id}', [App\Http\Controllers\PartnerController::class, 'deletepartner'])->name('partner.delete');
