...
class ProjectActivitiesInvoices extends Component
{
    ...
    public $project_small_description;
    public $proposal_id;
    public $date_format;
    ...
    public function mount( $project_id, $project_title, $project_description ,$project_author_id, $proposal_id, $profile_id, $userRole ){

        $this->project_id       = $project_id;
        $this->project_title    = $project_title;
        $this->project_small_description    = $project_small_description;
    ...
    public function updateActivity(){
        ...
        if(!empty($email_template)){
            ...
            $params['email_params']     = array(
                ...
                'project_small_description'         => $this->project_small_description,
