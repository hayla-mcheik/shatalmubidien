...
class PageBuilderController extends Controller 
{
    public function build(  Request $request ){
        ...
        $page_blocks = [
            ...
            'partner-block'      => __('pages.partner_block'),
            ...
            // Add the code to change the order of the "project" and "category" blocks
            $categoryIndex = array_search('categories-block', array_keys($page_blocks));
            $projectIndex = array_search('projects-block', array_keys($page_blocks));
            
            if ($categoryIndex !== false && $projectIndex !== false) {
                $temp = $page_blocks['categories-block'];
                $page_blocks['categories-block'] = $page_blocks['projects-block'];
                $page_blocks['projects-block'] = $temp;
            }
