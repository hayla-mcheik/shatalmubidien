...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('RstzS2x')) {
    $componentId = $_instance->getRenderedChildComponentId('RstzS2x');
    $componentTag = $_instance->getRenderedChildComponentTagName('RstzS2x');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RstzS2x');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('RstzS2x', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                   <?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('3lk0m5p')) {
    $componentId = $_instance->getRenderedChildComponentId('3lk0m5p');
    $componentTag = $_instance->getRenderedChildComponentTagName('3lk0m5p');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3lk0m5p');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('3lk0m5p', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
               </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('OFlqtL3')) {
    $componentId = $_instance->getRenderedChildComponentId('OFlqtL3');
    $componentTag = $_instance->getRenderedChildComponentTagName('OFlqtL3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OFlqtL3');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('OFlqtL3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
       </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.pagebuilder-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views\admin\pagebuilder.blade.php ENDPATH**/ ?>