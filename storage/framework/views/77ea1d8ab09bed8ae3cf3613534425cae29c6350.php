...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('vij3B9h')) {
    $componentId = $_instance->getRenderedChildComponentId('vij3B9h');
    $componentTag = $_instance->getRenderedChildComponentTagName('vij3B9h');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vij3B9h');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('vij3B9h', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
