                    ...
                    <table class="table tb-table tb-dbholder">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('project.project_small_description' )); ?></th>
                                <th><?php echo e(__('project.project_description' )); ?></th>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr> 
                                    ...
                                    <td data-label="<?php echo e(__('project.project_small_description' )); ?>"><span><?php echo $single->project_small_description; ?></span></td>
                                    <td data-label="<?php echo e(__('project.project_description' )); ?>"><span><?php echo $single->project_description; ?></span></td>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views/livewire/admin/projects/projects.blade.php ENDPATH**/ ?>