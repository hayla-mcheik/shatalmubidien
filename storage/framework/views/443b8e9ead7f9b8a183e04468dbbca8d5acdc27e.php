...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('QLFYgQf')) {
    $componentId = $_instance->getRenderedChildComponentId('QLFYgQf');
    $componentTag = $_instance->getRenderedChildComponentTagName('QLFYgQf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QLFYgQf');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('QLFYgQf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
		</div>
