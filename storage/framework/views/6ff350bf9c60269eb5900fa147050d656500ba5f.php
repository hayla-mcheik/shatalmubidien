...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('I6EbA6i')) {
    $componentId = $_instance->getRenderedChildComponentId('I6EbA6i');
    $componentTag = $_instance->getRenderedChildComponentTagName('I6EbA6i');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('I6EbA6i');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('I6EbA6i', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
