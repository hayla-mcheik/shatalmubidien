...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('JspfUzz')) {
    $componentId = $_instance->getRenderedChildComponentId('JspfUzz');
    $componentTag = $_instance->getRenderedChildComponentTagName('JspfUzz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JspfUzz');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('JspfUzz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php else: ?>
