...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('PZbATFr')) {
    $componentId = $_instance->getRenderedChildComponentId('PZbATFr');
    $componentTag = $_instance->getRenderedChildComponentTagName('PZbATFr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PZbATFr');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('PZbATFr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('Ici6RcR')) {
    $componentId = $_instance->getRenderedChildComponentId('Ici6RcR');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ici6RcR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ici6RcR');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('Ici6RcR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                <?php endif; ?>            
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views\front-end\gig\gig-activity.blade.php ENDPATH**/ ?>