...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('soZtqHS')) {
    $componentId = $_instance->getRenderedChildComponentId('soZtqHS');
    $componentTag = $_instance->getRenderedChildComponentTagName('soZtqHS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('soZtqHS');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('soZtqHS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views\front-end\sellers\search-sellers.blade.php ENDPATH**/ ?>