...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('mGEmV30')) {
    $componentId = $_instance->getRenderedChildComponentId('mGEmV30');
    $componentTag = $_instance->getRenderedChildComponentTagName('mGEmV30');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mGEmV30');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('mGEmV30', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('EdYtvaw')) {
    $componentId = $_instance->getRenderedChildComponentId('EdYtvaw');
    $componentTag = $_instance->getRenderedChildComponentTagName('EdYtvaw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EdYtvaw');
} else {
    $response = \Livewire\Livewire::mount('earnings.invoices', ['className' => 'tk-dbinvoice']);
    $html = $response->html();
    $_instance->logRenderedChild('EdYtvaw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('VxXM28Q')) {
    $componentId = $_instance->getRenderedChildComponentId('VxXM28Q');
    $componentTag = $_instance->getRenderedChildComponentTagName('VxXM28Q');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VxXM28Q');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('VxXM28Q', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views\front-end\dashboard\dashboard.blade.php ENDPATH**/ ?>