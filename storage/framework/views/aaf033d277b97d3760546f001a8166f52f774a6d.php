...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('RslEV7n')) {
    $componentId = $_instance->getRenderedChildComponentId('RslEV7n');
    $componentTag = $_instance->getRenderedChildComponentTagName('RslEV7n');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RslEV7n');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('RslEV7n', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views\front-end\gig\gig-listview.blade.php ENDPATH**/ ?>