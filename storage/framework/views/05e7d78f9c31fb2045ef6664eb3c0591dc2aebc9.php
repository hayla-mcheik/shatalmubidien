...
<script defer src="<?php echo e(asset('admin/js/main.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views/layouts/admin/footer_scripts.blade.php ENDPATH**/ ?>