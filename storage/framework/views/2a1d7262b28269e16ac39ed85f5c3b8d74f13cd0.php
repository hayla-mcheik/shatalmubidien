...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('pJnb7En')) {
    $componentId = $_instance->getRenderedChildComponentId('pJnb7En');
    $componentTag = $_instance->getRenderedChildComponentTagName('pJnb7En');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pJnb7En');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('pJnb7En', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
									<?php
...
} elseif ($_instance->childHasBeenRendered('DJVRAsz')) {
    $componentId = $_instance->getRenderedChildComponentId('DJVRAsz');
    $componentTag = $_instance->getRenderedChildComponentTagName('DJVRAsz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DJVRAsz');
} else {
    $response = \Livewire\Livewire::mount('seller.seller-portfolios', ['userProfileId' => $profile->id,'user_profile_id' => $profile->id]);
    $html = $response->html();
    $_instance->logRenderedChild('DJVRAsz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
									<?php
...
} elseif ($_instance->childHasBeenRendered('GCg683Y')) {
    $componentId = $_instance->getRenderedChildComponentId('GCg683Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('GCg683Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GCg683Y');
} else {
    $response = \Livewire\Livewire::mount('seller.seller-education', ['userProfileId' => $profile->id,'user_profile_id' => $profile->id]);
    $html = $response->html();
    $_instance->logRenderedChild('GCg683Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
									<?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('huXCnY0')) {
    $componentId = $_instance->getRenderedChildComponentId('huXCnY0');
    $componentTag = $_instance->getRenderedChildComponentTagName('huXCnY0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('huXCnY0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('huXCnY0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
							</div>
...
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views\front-end\sellers\profile.blade.php ENDPATH**/ ?>