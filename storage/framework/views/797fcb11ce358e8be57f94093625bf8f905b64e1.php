...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('2t7uu8T')) {
    $componentId = $_instance->getRenderedChildComponentId('2t7uu8T');
    $componentTag = $_instance->getRenderedChildComponentTagName('2t7uu8T');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2t7uu8T');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('2t7uu8T', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views\livewire\project\project-step2.blade.php ENDPATH**/ ?>