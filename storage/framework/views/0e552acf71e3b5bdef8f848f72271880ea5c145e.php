...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('YcfMSDr')) {
    $componentId = $_instance->getRenderedChildComponentId('YcfMSDr');
    $componentTag = $_instance->getRenderedChildComponentTagName('YcfMSDr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YcfMSDr');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('YcfMSDr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('F6yru4F')) {
    $componentId = $_instance->getRenderedChildComponentId('F6yru4F');
    $componentTag = $_instance->getRenderedChildComponentTagName('F6yru4F');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('F6yru4F');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('F6yru4F', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views\livewire\project\project-activity.blade.php ENDPATH**/ ?>