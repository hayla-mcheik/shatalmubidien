...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('VyApzTa')) {
    $componentId = $_instance->getRenderedChildComponentId('VyApzTa');
    $componentTag = $_instance->getRenderedChildComponentTagName('VyApzTa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VyApzTa');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('VyApzTa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                   <?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('eAhWcNa')) {
    $componentId = $_instance->getRenderedChildComponentId('eAhWcNa');
    $componentTag = $_instance->getRenderedChildComponentTagName('eAhWcNa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eAhWcNa');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('eAhWcNa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
               </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('FhhEVTJ')) {
    $componentId = $_instance->getRenderedChildComponentId('FhhEVTJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('FhhEVTJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FhhEVTJ');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('FhhEVTJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
       </div>
