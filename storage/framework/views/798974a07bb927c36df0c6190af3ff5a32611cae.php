...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('AwUH5ID')) {
    $componentId = $_instance->getRenderedChildComponentId('AwUH5ID');
    $componentTag = $_instance->getRenderedChildComponentTagName('AwUH5ID');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AwUH5ID');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('AwUH5ID', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views/front-end/projects/search-projects.blade.php ENDPATH**/ ?>