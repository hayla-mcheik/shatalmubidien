...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('055fdrD')) {
    $componentId = $_instance->getRenderedChildComponentId('055fdrD');
    $componentTag = $_instance->getRenderedChildComponentTagName('055fdrD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('055fdrD');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('055fdrD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
		</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shatal\shathalmubdiein-web-panel-main\resources\views\front-end\gig\gig-gridview.blade.php ENDPATH**/ ?>