...
class DefaultPageSettingSeeder extends Seeder
{
    ...
    {
        $truncateValues = [
            'header-block', 'search-talent-block', 
            'partner-block', 'mobile-app-block', 'footer-block',
            'projects-block', 'categories-block', 'opportunities-block', 'terms-condition-block',
        ...
        $defaultValues = [
            ...
            array(
                'setting_type'  => 'footer-block',
                'meta_key'      => 'logo_image',
                'meta_value'    => 'demo-content/shaza-logo.png',
            ),
            array(
                'setting_type'  => 'footer-block',
