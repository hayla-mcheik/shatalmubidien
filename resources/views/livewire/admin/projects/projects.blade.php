                    ...
                    <table class="table tb-table tb-dbholder">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('project.project_small_description' )}}</th>
                                <th>{{ __('project.project_description' )}}</th>
                        ...
                        <tbody>
                            @foreach($projects as $single)
                                ...
                                <tr> 
                                    ...
                                    <td data-label="{{ __('project.project_small_description' )}}"><span>{!! $single->project_small_description !!}</span></td>
                                    <td data-label="{{ __('project.project_description' )}}"><span>{!! $single->project_description !!}</span></td>
